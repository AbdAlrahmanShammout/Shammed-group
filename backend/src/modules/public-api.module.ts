...
@Module({
  imports: [LocationModule, SiteSettingsModule, SocialLinkModule],
  controllers: [LocationPublicController, SiteSettingsPublicController, SocialLinkPublicController],
})
